...
func (x *ListBlogRepsonse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListBlogRepsonse) ProtoMessage() {}

func (x *ListBlogRepsonse) ProtoReflect() protoreflect.Message {
	mi := &file_blog_blogpb_blog_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListBlogRepsonse.ProtoReflect.Descriptor instead.
func (*ListBlogRepsonse) Descriptor() ([]byte, []int) {
	return file_blog_blogpb_blog_proto_rawDescGZIP(), []int{10}
}

func (x *ListBlogRepsonse) GetBlog() *Blog {
	if x != nil {
		return x.Blog
	}
	return nil
...
var file_blog_blogpb_blog_proto_rawDesc = []byte{
	...
	0x74, 0x42, 0x6c, 0x6f, 0x67, 0x52, 0x65, 0x70, 0x73, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1e, 0x0a,
	0x04, 0x62, 0x6c, 0x6f, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x62, 0x6c,
	0x6f, 0x67, 0x2e, 0x42, 0x6c, 0x6f, 0x67, 0x52, 0x04, 0x62, 0x6c, 0x6f, 0x67, 0x32, 0xd4, 0x02,
	0x0a, 0x0d, 0x42, 0x6c, 0x6f, 0x67, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x69, 0x63, 0x65, 0x12,
	...
	0x22, 0x00, 0x12, 0x3b, 0x0a, 0x08, 0x52, 0x65, 0x61, 0x64, 0x42, 0x6c, 0x6f, 0x67, 0x12, 0x15,
	...
	0x64, 0x42, 0x6c, 0x6f, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12,
	0x41, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x6c, 0x6f, 0x67, 0x12, 0x17, 0x2e,
	...
	0x22, 0x00, 0x12, 0x41, 0x0a, 0x0a, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x42, 0x6c, 0x6f, 0x67,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3d, 0x0a, 0x08, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x6c, 0x6f,
	0x67, 0x12, 0x15, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x6c, 0x6f,
	0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e,
	0x4c, 0x69, 0x73, 0x74, 0x42, 0x6c, 0x6f, 0x67, 0x52, 0x65, 0x70, 0x73, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x00, 0x30, 0x01, 0x42, 0x08, 0x5a, 0x06, 0x62, 0x6c, 0x6f, 0x67, 0x70, 0x62, 0x62, 0x06,
...
var file_blog_blogpb_blog_proto_goTypes = []interface{}{
	...
	(*ListBlogRepsonse)(nil),   // 10: blog.ListBlogRepsonse
}
var file_blog_blogpb_blog_proto_depIdxs = []int32{
	...
	0,  // 5: blog.ListBlogRepsonse.blog:type_name -> blog.Blog
	1,  // 6: blog.BlogServerice.CreateBlog:input_type -> blog.CreateBlogRequest
	3,  // 7: blog.BlogServerice.ReadBlog:input_type -> blog.ReadBlogRequest
	5,  // 8: blog.BlogServerice.UpdateBlog:input_type -> blog.UpdateBlogRequest
	7,  // 9: blog.BlogServerice.DeleteBlog:input_type -> blog.DeleteBlogRequest
	9,  // 10: blog.BlogServerice.ListBlog:input_type -> blog.ListBlogRequest
	2,  // 11: blog.BlogServerice.CreateBlog:output_type -> blog.CreateBlogResponse
	4,  // 12: blog.BlogServerice.ReadBlog:output_type -> blog.ReadBlogResponse
	6,  // 13: blog.BlogServerice.UpdateBlog:output_type -> blog.UpdateBlogResponse
	8,  // 14: blog.BlogServerice.DeleteBlog:output_type -> blog.DeleteBlogResponse
	10, // 15: blog.BlogServerice.ListBlog:output_type -> blog.ListBlogRepsonse
...
type BlogServericeClient interface {
	...
	ListBlog(ctx context.Context, in *ListBlogRequest, opts ...grpc.CallOption) (BlogServerice_ListBlogClient, error)
}
...
func (c *blogServericeClient) DeleteBlog(ctx context.Context, in *DeleteBlogRequest, opts ...grpc.CallOption) (*DeleteBlogResponse, error) {
	out := new(DeleteBlogResponse)
	err := c.cc.Invoke(ctx, "/blog.BlogServerice/DeleteBlog", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *blogServericeClient) ListBlog(ctx context.Context, in *ListBlogRequest, opts ...grpc.CallOption) (BlogServerice_ListBlogClient, error) {
	stream, err := c.cc.NewStream(ctx, &_BlogServerice_serviceDesc.Streams[0], "/blog.BlogServerice/ListBlog", opts...)
	if err != nil {
		return nil, err
	}
	x := &blogServericeListBlogClient{stream}
...
type BlogServerice_ListBlogClient interface {
	Recv() (*ListBlogRepsonse, error)
	grpc.ClientStream
}

type blogServericeListBlogClient struct {
	grpc.ClientStream
}

func (x *blogServericeListBlogClient) Recv() (*ListBlogRepsonse, error) {
	m := new(ListBlogRepsonse)
...
type BlogServericeServer interface {
	...
	ListBlog(*ListBlogRequest, BlogServerice_ListBlogServer) error
}
...
func (*UnimplementedBlogServericeServer) DeleteBlog(context.Context, *DeleteBlogRequest) (*DeleteBlogResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteBlog not implemented")
}
func (*UnimplementedBlogServericeServer) ListBlog(*ListBlogRequest, BlogServerice_ListBlogServer) error {
...
func _BlogServerice_DeleteBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteBlogRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlogServericeServer).DeleteBlog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.BlogServerice/DeleteBlog",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServericeServer).DeleteBlog(ctx, req.(*DeleteBlogRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _BlogServerice_ListBlog_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ListBlogRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BlogServericeServer).ListBlog(m, &blogServericeListBlogServer{stream})
}

type BlogServerice_ListBlogServer interface {
	Send(*ListBlogRepsonse) error
	grpc.ServerStream
}

type blogServericeListBlogServer struct {
	grpc.ServerStream
}

func (x *blogServericeListBlogServer) Send(m *ListBlogRepsonse) error {
...
var _BlogServerice_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BlogServerice_DeleteBlog_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "ListBlog",
			Handler:       _BlogServerice_ListBlog_Handler,
			ServerStreams: true,
		},
	},
